	...
	<div class="col-sm-3 col-md-2 sidebar">
		...
		<div class="drop-navigation drop-navigation">
			<ul class="nav nav-sidebar">
				...
				<li><a href="gerenzx.html" class="sub-icon"><span
						class="glyphicon glyphicon-asterisk" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;个人中心</a></li>
				<li class="active"><a href="#" class="sub-icon"><span
					...
					<div class="row">
						<div class="sayBox">
								...
								<div class="media-left">
									<div class="media-object">
										<img src="images/sunwukong.jpg"
											style="height: 60px; width: 60px;" class="img-circle">
									</div>
								</div>
								<div class="media-body">
									<span class="media-heading lead">草泥马 赞了</span><span
							...
							<div class="media say">
								...
								<div class="media-body">
									<span class="media-heading lead">路易斯 回复 你</span><span
										class="media-heading lead"> 2016-8-20 11:35:35</span>
							...
							<div class="media say">
								...
								<div class="media-body">
									<span class="media-heading lead">布尔玛</span><span
										class="media-heading lead"> 留言 :</span>
									<p class="well">真是日了狗</p>
