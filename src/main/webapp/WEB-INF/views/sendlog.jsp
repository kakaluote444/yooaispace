	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<div class="show-top-grids row">
			...
			<div class="row col-md-10 col-md-push-1"  >
				...
				<div id="logTitle">
					<input type="text" size="50" placeholder="日志标题" name="logTitle" style="height: 50px;width: 100%;font-size: 24px;line-height: 24px;text-align: center"/>
				</div>
				<div id="logContent" style="text-align: center">
					<script id="editor" type="text/plain"
						style="width:100%;height:300px;" name="logContent"></script>
					<input type="submit" value="发表" class="btn btn-danger" style="height: 50px;width: 250px">
				</div>
			</form>
			</div>
			<!--自定义部分结束-->
