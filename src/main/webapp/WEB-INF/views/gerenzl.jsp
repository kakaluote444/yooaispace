		...
		<div class="col-sm-3 col-md-2 sidebar">
			...
			<div class="drop-navigation drop-navigation">
				<ul class="nav nav-sidebar">
					...
					<li><a href="gerenzx.html" class="sub-icon"><span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;个人中心</a></li>
					...
					<li class="active"><a href="liuyan.html" class="sub-icon"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;留言</a></li>
					<li><a href="gerenzx.html" class="sub-icon"><span class="glyphicon glyphicon-th-list" aria-hidden="true" ></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;个人资料</a></li>
					<!-- script-for-menu -->
					<script>
